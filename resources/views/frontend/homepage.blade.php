                    ...
                    <a class="category-item mb-4" href="{{ route('shop.index', $categories[1]->slug) }}">
                        ...
                        @else
                            <img class="img-fluid"
                                 ...
                                 alt="{{ $categories[1]->name ?? '' }}">
                        @endif
                        <strong class="category-item-title" style="margin-top: -124px;">{{ $categories[1]->name ?? 'mslms' }}</strong>
                    </a>
                    <a class="category-item" href="{{ route('shop.index', $categories[2]->slug) }}">
                        ...
                        @else
                            <img class="img-fluid"
                                 ...
                                 alt="{{ $categories[2]->name ?? '' }}">
                        @endif
                        <strong class="category-item-title" style="margin-top: 124px;">{{ $categories[2]->name ?? 'mlsmls' }}</strong>
                    </a>
                </div>
                <div class="col-md-4">
                    <a class="category-item" href="{{ route('shop.index', $categories[3]->slug) }}">
                        ...
                        @endif
                        <strong class="category-item-title">{{ $categories[3]->name ?? 'mlsms' }}</strong>
                    </a>
                </div>
            </div>
        </section>
...
<!-- TRENDING PRODUCTS -->
<div class="container">
    <livewire:frontend.products.top-trending-products />
</div>
